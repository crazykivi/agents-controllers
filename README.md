...
- **Права агента** настраиваются per-agent: авто-подтверждение вопросов
  ...
  (`--detect-urls`, по умолчанию выключен).
  Если авто-подтверждение выключено, aider каждый вопрос показывает в
  терминале — подтверждать кнопками Да/Нет над строкой ввода.
